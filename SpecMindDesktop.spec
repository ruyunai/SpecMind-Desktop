...
a = Analysis(
    ...
    # 数据文件：QSS 主题 + chromadb/pdfplumber + SSL证书 + openai/httpx
    datas=[
        (str(PROJ_ROOT / "src" / "gui" / "styles" / "dark_theme.qss"),
         "gui/styles"),
    ] + chromadb_datas + pdfplumber_datas + certifi_datas + openai_datas + httpx_datas,
